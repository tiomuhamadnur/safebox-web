					...
					<div class="card shadow mb-4">
							...
							<div class="col-md-12">
								<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
									<div class="form-group">
										...
										<input type="text" name="nama" class="form-control" value="<?php echo $nama; ?>" placeholder="Input nama tim" required>
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" name="mail" class="form-control" value="<?php echo $mail; ?>" placeholder="Input email tim/karyawan">
											<span class="help-block"><?php echo $mail_err; ?></span>
										</div>
									</div>
									<div class="form-group">
										<label for="division">Departemen</label>
										<input type="text" name="division" class="form-control" placeholder="Input nama departemen">
										<!--
						...
						-->
									...
									<div class="form-group">
										...
										<textarea name="alamat" class="form-control" placeholder="Input alamat"><?php echo $alamat; ?></textarea>
