      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 animate__animated animate__fadeInLeft">Dashboard</h1>
          ...
          <div class="row">
            ...
            <div class="col-xl-5 mx-auto py-4 animate__animated animate__fadeInDown">
            ...
            <!-- Earnings (Monthly) Card Example -->
            <div class="col-xl-5 mx-auto py-4 animate__animated animate__fadeInUp">
